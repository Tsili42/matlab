clear all;
% N = 7, d = 4cm, 2 sound sources with arg1 = 45 and arg2 = 135, noise from
% 500Hz to 2.5kHz, fs = 48kHz
N = 7;
d = 0.04;
c = 340;
n = 0:1:6;
...
audiowrite('sim_ds.wav', Real_signal, fs);
...
midmicSNR = snr(sens(4,:), voice' - sens(4,:))
convbeamfSNR = snr(Real_signal, voice - Real_signal)
